...
const DiarrheaConstipationScreen = ({ navigation }) => {
  ...
  const [symptomType, setSymptomType] = useState(''); // 'diarrhea' or 'constipation'
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Digestive Health Analysis</Text>
      </View>

      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {/* Symptom Type Selector */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Select Your Main Symptom</Text>
          <View style={styles.symptomButtons}>
            <TouchableOpacity 
              style={[
                styles.symptomButton, 
                symptomType === 'diarrhea' && { backgroundColor: theme.colors.primary + '20' }
              ]}
              onPress={() => setSymptomType('diarrhea')}
            >
              <Ionicons 
                name="water" 
                size={24} 
                color={symptomType === 'diarrhea' ? theme.colors.primary : theme.colors.textSecondary} 
              />
              <Text style={[
                styles.symptomButtonText, 
                { color: symptomType === 'diarrhea' ? theme.colors.primary : theme.colors.text }
              ]}>
                Diarrhea
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity 
              style={[
                styles.symptomButton, 
                symptomType === 'constipation' && { backgroundColor: theme.colors.primary + '20' }
              ]}
              onPress={() => setSymptomType('constipation')}
            >
              <Ionicons 
                name="alert-circle" 
                size={24} 
                color={symptomType === 'constipation' ? theme.colors.primary : theme.colors.textSecondary} 
              />
              <Text style={[
                styles.symptomButtonText, 
                { color: symptomType === 'constipation' ? theme.colors.primary : theme.colors.text }
              ]}>
                Constipation
              </Text>
            </TouchableOpacity>
        ...
        <View style={styles.section}>
          ...
          <TextInput
            style={styles.input}
            placeholder="Describe your digestive symptoms (frequency, consistency, pain, duration, etc.)..."
...
export default DiarrheaConstipationScreen;