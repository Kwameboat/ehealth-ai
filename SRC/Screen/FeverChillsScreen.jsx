...
const FeverChillsScreen = ({ navigation }) => {
  ...
  const submitSymptoms = async () => {
    if (!userNotes.trim() && !temperature && !duration) {
      Alert.alert('Input Required', 'Please describe your symptoms first');
      return;
    }
    
    const symptomsText = `Temperature: ${temperature || 'Not provided'}°C\n
    Duration: ${duration || 'Not provided'}\n
    Additional Symptoms: ${symptoms || 'None'}\n
  ...
  const analyzeTextWithGemini = async (text) => {
    ...
    try {
      const prompt = `The user is experiencing fever and chills with these details:
      ${text}
  ...
  const analyzeImageWithGemini = async (imageUri) => {
    ...
    try {
      ...
      const prompt = `Analyze this medical image related to fever and chills. 
  ...
  const renderAnalysisResult = () => {
    ...
    return sections.map((section, index) => {
      ...
      if (section.includes('Home Care:')) {
        return (
          <View key={index} style={styles.sectionContainer}>
            <Text style={styles.sectionTitle}>Home Care Remedies</Text>
            <Text style={styles.resultText}>
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Fever & Chills Analysis</Text>
        <FontAwesome5 name="temperature-high" size={24} color={theme.colors.text} style={styles.headerIcon} />
      </View>

      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {/* Fever-specific input */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Fever Details</Text>
          
          <View style={styles.row}>
            <View style={styles.inputContainer}>
              <Text style={[styles.inputLabel, { color: theme.colors.text }]}>Temperature (°C)</Text>
              <TextInput
          ...
          <Text style={[styles.inputLabel, { color: theme.colors.text }]}>Additional Symptoms</Text>
          <TextInput
            style={[styles.input, { 
              backgroundColor: theme.colors.background, 
              color: theme.colors.text,
            ...
            placeholder="Headache, nausea, body aches..."
            placeholderTextColor={theme.colors.textSecondary}
            value={symptoms}
        ...
        <View style={styles.section}>
          ...
          <TextInput
            ...
            placeholder="Describe how you're feeling, when the chills started, etc..."
            placeholderTextColor={theme.colors.textSecondary}
            multiline
            value={userNotes}
        ...
        <View style={styles.section}>
          ...
          <Text style={[styles.sectionSubtitle, { color: theme.colors.textSecondary }]}>
            Upload temperature readings or symptom photos
          </Text>
        ...
        {analysisResult ? (
          ...
          <View style={[styles.placeholderContainer, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.placeholderText, { color: theme.colors.text }]}>
              Provide your fever details or upload an image to get started
            </Text>
          </View>
        )}
      </ScrollView>
            ...
            {isRecognizing ? (
              <View style={styles.recordingContainer}>
                ...
                <Text style={[styles.recordingText, { color: theme.colors.text }]}>
                  Listening... Describe your fever and chills
                </Text>
              </View>
            ) : (
              <View>
...
export default FeverChillsScreen;