...
const VomitingNauseaScreen = ({ navigation }) => {
  ...
  const [vomitingFrequency, setVomitingFrequency] = useState('');
  const [nauseaSeverity, setNauseaSeverity] = useState('');
  const [associatedSymptoms, setAssociatedSymptoms] = useState([]);

  // Vomiting & Nausea specific symptoms
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Vomiting & Nausea Analysis</Text>
      </View>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.section}>
          ...
          {/* Vomiting Frequency Input */}
          <Text style={styles.inputLabel}>How frequently are you vomiting?</Text>
          <View style={styles.patternContainer}>
            {['Not vomiting', 'Once', '2-3 times', '4+ times', 'Continuous'].map(frequency => (
              <TouchableOpacity
                key={frequency}
                style={[
                  styles.patternButton,
                  vomitingFrequency === frequency && { backgroundColor: theme.colors.primary }
                ]}
                onPress={() => setVomitingFrequency(frequency)}
              >
                <Text style={[
                  styles.patternText,
                  vomitingFrequency === frequency && { color: theme.colors.buttonText }
                ]}>
                  {frequency}
                </Text>
              </TouchableOpacity>
          ...
          {/* Nausea Severity Input */}
          <Text style={styles.inputLabel}>How severe is your nausea?</Text>
            ...
            {['Mild', 'Moderate', 'Severe', 'Debilitating'].map(severity => (
              <TouchableOpacity
                ...
                style={[
                  ...
                  nauseaSeverity === severity && { backgroundColor: theme.colors.primary }
                ]}
                onPress={() => setNauseaSeverity(severity)}
              >
                <Text style={[
                  styles.severityText,
                  nauseaSeverity === severity && { color: theme.colors.buttonText }
                ]}>
                  {severity}
                </Text>
              </TouchableOpacity>
          ...
          <TextInput
            ...
            placeholder="Describe your vomiting, nausea, triggers, when it worsens, etc..."
            placeholderTextColor={theme.colors.textSecondary}
            multiline
            value={userNotes}
        ...
        <View style={[styles.warningContainer, { backgroundColor: theme.colors.danger + '20' }]}>
          ...
          <Text style={[styles.warningText, { color: theme.colors.danger }]}>
            Seek immediate medical attention if experiencing severe dehydration, blood in vomit, severe abdominal pain, or symptoms lasting more than 24 hours.
          </Text>
        </View>
        ...
        <View style={[styles.tipsContainer, { backgroundColor: theme.colors.card + '80' }]}>
          ...
          <Text style={[styles.tipsText, { color: theme.colors.text }]}>
            Try sipping clear fluids, electrolyte solutions, or ginger tea to stay hydrated and reduce nausea.
          </Text>
        </View>
...
export default VomitingNauseaScreen;