...
const SkinIssuesScreen = ({ navigation }) => {
  ...
  const submitSymptoms = async () => {
    if (!userNotes.trim() && !skinCondition && !affectedArea) {
      Alert.alert('Input Required', 'Please describe your skin symptoms first');
      return;
    }
    
    const symptomsText = `Skin Condition: ${skinCondition || 'Not provided'}\n
    Affected Area: ${affectedArea || 'Not provided'}\n
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Skin Issues Analysis</Text>
        <FontAwesome5 name="allergies" size={24} color={theme.colors.text} style={styles.headerIcon} />
      </View>

      <ScrollView contentContainerStyle={styles.scrollContainer}>
        {/* Skin-specific input */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Skin Condition Details</Text>
          
          <View style={styles.row}>
            <View style={styles.inputContainer}>
              <Text style={[styles.inputLabel, { color: theme.colors.text }]}>Skin Condition</Text>
              <TextInput
            ...
            <View style={styles.inputContainer}>
              <Text style={[styles.inputLabel, { color: theme.colors.text }]}>Affected Area</Text>
              <TextInput
                style={[styles.smallInput, { 
                  backgroundColor: theme.colors.background, 
                  color: theme.colors.text,
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Describe Your Skin Condition</Text>
          <TextInput
            style={[styles.input, { 
              backgroundColor: theme.colors.background, 
              color: theme.colors.text,
            ...
            placeholder="Describe your skin symptoms in detail..."
            placeholderTextColor={theme.colors.textSecondary}
            multiline
            value={userNotes}
        ...
        {analysisResult ? (
          ...
          <View style={[styles.placeholderContainer, { backgroundColor: theme.colors.card }]}>
            ...
            <Text style={[styles.placeholderText, { color: theme.colors.text }]}>
              Describe your skin symptoms or upload an image to get started
            </Text>
          </View>
        )}
      </ScrollView>
            ...
            {isRecognizing ? (
              <View style={styles.recordingContainer}>
                ...
                <Text style={[styles.recordingText, { color: theme.colors.text }]}>
                  Listening... Describe your skin condition
                </Text>
              </View>
            ) : (
              <View>
...
export default SkinIssuesScreen;