...
const HeadacheMigraineScreen = ({ navigation }) => {
  ...
  const analyzeTextWithGemini = async (text) => {
    ...
    try {
      const prompt = `The user is describing headache symptoms: "${text}". 
      Please provide a detailed analysis of potential headache types, 
  ...
  const analyzeImageWithGemini = async (imageUri) => {
    ...
    try {
      ...
      const prompt = `Analyze this image of a person's headache condition. 
      Provide a detailed analysis of potential headache types, symptoms, 
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Headache & Migraine Analysis</Text>
      </View>
