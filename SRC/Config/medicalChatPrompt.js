...
export const MEDICAL_CHAT_MODEL_ACK = `Understood. I will ask at most ${MAX_TRIAGE_FOLLOW_UP_QUESTIONS} follow-up questions (one at a time), then give clear recommendations without asking more questions. I will escalate emergencies immediately.`;

export const TRIAGE_RECOMMENDATION_DIRECTIVE = `TRIAGE LIMIT REACHED: You have already asked ${MAX_TRIAGE_FOLLOW_UP_QUESTIONS} follow-up questions in this conversation.
